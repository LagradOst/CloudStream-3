...
import com.ArjixWasTaken.cloudstream3.BuildConfig
...
class InAppUpdater {
    companion object {
        ...
        private fun Activity.getReleaseUpdate(): Update {
            val url = "https://api.github.com/repos/ArjixWasTaken/CloudStream-3/releases"
        ...
        private fun Activity.getPreReleaseUpdate(): Update {
            val tagUrl = "https://api.github.com/repos/ArjixWasTaken/CloudStream-3/git/ref/tags/pre-release"
            val releaseUrl = "https://api.github.com/repos/ArjixWasTaken/CloudStream-3/releases"
            val headers = mapOf("Accept" to "application/vnd.github.v3+json")
            val response =
